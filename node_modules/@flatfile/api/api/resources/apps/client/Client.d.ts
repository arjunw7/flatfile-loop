...
export declare class Apps {
     ...
     */
    getConstraints(appId: Flatfile.AppId, request?: Flatfile.GetConstraintsRequest, requestOptions?: Apps.RequestOptions): Promise<Flatfile.ConstraintsResponse>;
    /**
     * Creates a new constraint for an app
     */
    createConstraint(appId: Flatfile.AppId, request: Flatfile.ConstraintCreate, requestOptions?: Apps.RequestOptions): Promise<Flatfile.ConstraintResponse>;
    /**
     * Returns a specific constraint
     */
    getConstraintById(appId: Flatfile.AppId, constraintId: Flatfile.ConstraintId, requestOptions?: Apps.RequestOptions): Promise<Flatfile.ConstraintResponse>;
    /**
     * Updates a specific constraint
     */
    updateConstraint(appId: Flatfile.AppId, constraintId: Flatfile.ConstraintId, request: Flatfile.ConstraintUpdate, requestOptions?: Apps.RequestOptions): Promise<Flatfile.ConstraintResponse>;
    /**
     * Deletes a specific constraint
     */
    deleteConstraint(appId: Flatfile.AppId, constraintId: Flatfile.ConstraintId, requestOptions?: Apps.RequestOptions): Promise<Flatfile.SuccessResponse>;
