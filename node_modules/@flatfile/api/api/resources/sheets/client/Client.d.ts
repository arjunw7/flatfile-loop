...
export declare class Sheets {
     ...
     * @throws {@link Flatfile.NotFoundError}
     */
    addField(sheetId: Flatfile.SheetId, request: Flatfile.CreateFieldRequest, requestOptions?: Sheets.RequestOptions): Promise<Flatfile.FieldConfigResponse>;
    /**
     * Removes field from a sheet
     * @throws {@link Flatfile.BadRequestError}
     * @throws {@link Flatfile.NotFoundError}
     */
    removeField(sheetId: Flatfile.SheetId, fieldKey: string, requestOptions?: Sheets.RequestOptions): Promise<Flatfile.Success>;
    /**
